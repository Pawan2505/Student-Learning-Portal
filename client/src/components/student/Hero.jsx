...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full d:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
      ...
      className='md:block hidden absolute -bottom-7 right-0'></img> </h1>
